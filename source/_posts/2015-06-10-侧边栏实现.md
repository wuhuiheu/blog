...
&nbsp;&nbsp;&nbsp;&nbsp;话不多说，直接上图
	<div  align="center">    
		<img src="http://i.imgur.com/nmnIy4h.png" width = "30%" height = "30%" alt="效果图" align=center />
	</div>

# 二、布局 #
&nbsp;&nbsp;&nbsp;&nbsp;activity采用FrameLayout，点击Home图标的时候，显示侧边栏。而侧边栏布局采用LinearLayout，左边ListView，右边一个采用一个View标签。
...
layout_main.xml
    ...
    <TextView
        ...
        android:text="点击左上角图标左边的箭头,就可以看到侧边栏效果了!!!" />
...
# 三、侧边栏实现 #
	...
	public class RibbonMenuView extends LinearLayout {
	    ...
	    private void inflateLayout() {
	        try {
	            LayoutInflater.from(getContext()).inflate(R.layout.activity_custom_ribbon_menu, this, true);
	        } catch (Exception e) {
	    ...
	    private void initUi() {
	        ...
	        rbmOutsideView.setOnClickListener(new OnClickListener() {// 菜单其他部分点击将隐藏菜单
	        ...
	        rbmListView.setOnItemClickListener(new OnItemClickListener() {// 点击菜单将回调，并隐藏菜单
	    ...
	    /** 传入一个菜单资源文件id，然后解析菜单资源文件，获取相应菜单信息 */
	    ...
	    /** 解析menu,将得到的menuItem存入menuItems中 */
	            ...
	            while (eventType != XmlPullParser.END_DOCUMENT) {
	                if (eventType == XmlPullParser.START_TAG) {
	                    ...
	                    if (elemName.equals("item")) {
	                        ...
	                        Log.d("ljhtest", "" + textId + " " + iconId + " " + resId);
